/* versao do escalonador que só falta resolver o problema da volta para fila de alta quando sai de IO */
...
void roundRobinComIO(processo processos[], int quantum){
    ...
    if((cont_reg_disco != -1) || (cont_reg_fita != -1) || (cont_reg_impressora != -1)){
       if (cont_reg_disco > 0) {
        printf("Decrementando contagem disco\n");
            cont_reg_disco--;
        ...
        if (cont_reg_fita > 0) {
            printf("Decrementando contagem fita\n");
            cont_reg_fita--;
        ...
        if (cont_reg_impressora > 0) {
            printf("Decrementando contagem impressora\n");
            cont_reg_impressora--;
